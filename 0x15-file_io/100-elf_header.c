...
/**
 * print_version - To prints the version of an ELF header.
...
/**
 * print_osabi - To prints the OS/ABI of an ELF header.
 * @e_ident: The pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * print_abi - To prints the ABI version of an ELF header.
...
/**
 * print_entry - To prints the entry point of an ELF header.
...
/**
 * main - To displays the information contained in the
